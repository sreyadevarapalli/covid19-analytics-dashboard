...
function useCountryComparison(country1, country2) {
  const [countryOneData, setCountryOneData] = useState(null);
  const [countryTwoData, setCountryTwoData] = useState(null);
